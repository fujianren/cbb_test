...
import com.cbb.myapplication.fragment.ContentFragment;
import com.cbb.sidemenu.interfaces.Resourceble;
import com.cbb.sidemenu.interfaces.ScreenShotable;
import com.cbb.sidemenu.model.SlideMenuItem;
import com.cbb.sidemenu.util.ViewAnimator;
...
public class SideMenuActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_sidemenu, menu);
        return true;
    }
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        int finalRadius = Math.max(view.getWidth(), view.getHeight());  // 波纹半径
        // io包下的动画
